    ...
    return (
        <View style={[styles.container, styles.button_container, style]}>
            ...
            <View style={[_styles.help_container, styles.ui_element]}>
                <Text style={[styles.font_20, styles.font_center, styles.font_bold]}>
                    Welcome to LMS Dragster!
                </Text>
                <Text style={[styles.font_20, styles.font_justify]}>
                    This companion educational app will help you learn more about our dragsters. 
